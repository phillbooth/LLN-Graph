...
//
// Diagnostic codes: LLN-BOUNDARY-001..004 (canonical to logicn-core-compiler).
// =============================================================================
...
export const LLN_BOUNDARY_DIAGNOSTICS = [
  LLN_BOUNDARY_001,
  LLN_BOUNDARY_002,
  LLN_BOUNDARY_003,
  LLN_BOUNDARY_004,
...
export function validateBoundaries(graph: BoundaryGraph): LlnDiagnostic[] {
  ...
  for (const edge of graph.edges()) {
    ...
    // LLN-BOUNDARY-001: effect not allowed at target boundary.
    ...
    // LLN-BOUNDARY-002: secrets crossing a non-secret boundary.
    ...
    // LLN-BOUNDARY-003: untrusted source without validation.
    ...
    // LLN-BOUNDARY-004: required policies declared but not met.
