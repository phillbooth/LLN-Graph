...
//
// Diagnostic codes: LLN-EFFECT-001..004 (canonical to logicn-core-compiler).
// =============================================================================
...
export const LLN_EFFECT_DIAGNOSTICS = [
  LLN_EFFECT_001,
  LLN_EFFECT_002,
  LLN_EFFECT_003,
  LLN_EFFECT_004,
...
export function validateEffects(graph: EffectGraph): LlnDiagnostic[] {
  ...
  for (const node of graph.nodes()) {
    ...
    // LLN-EFFECT-001: inferred effect not declared.
    ...
    // LLN-EFFECT-002: declared effect not inferred (dead declaration).
    ...
    // LLN-EFFECT-003: safe flow has any effects.
    ...
    // LLN-EFFECT-004: transitive effect not declared on caller.
