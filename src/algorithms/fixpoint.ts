...
import { LLN_GRAPH_004 } from "../core/types.js";

/** Default maximum iterations before emitting LLN-GRAPH-004. */
...
export type FixpointResult<N, E> =
  ...
  | {
      ...
      readonly diagnostic: typeof LLN_GRAPH_004;
    };
