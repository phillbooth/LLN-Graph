...
export interface GraphJSON<N, E> {
  readonly schemaVersion: "lln.graph.v1";
...
// ---------------------------------------------------------------------------
// LLN-GRAPH diagnostic constants
// ---------------------------------------------------------------------------

/** A cycle was found in a graph that must be a DAG. */
export const LLN_GRAPH_001 = {
  code: "LLN-GRAPH-001",
  name: "CYCLE_DETECTED",
  severity: "error",
...
export const LLN_GRAPH_DIAGNOSTICS = [
  LLN_GRAPH_001,
  LLN_GRAPH_002,
  LLN_GRAPH_003,
  LLN_GRAPH_004,
